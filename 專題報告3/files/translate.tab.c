...
static const char *const yytname[] =
{
  ...
  "PLUS", "MINUS", "MULT", "DIV", "ASSIGN", "PRINT", "LPAREN", "RPAREN",
...
{
       1,    10,    11,     7,    16,    17,     2,    18,    19,    21,
      22,     6,    23,    24,     8,    15,    20,     9
};

static const yytype_int8 yycheck[] =
{
       4,     3,     4,    11,     5,     6,    10,     7,     8,    16,
      17,     9,    18,    19,     0,     4,    12,     4
};
...
{
       0,     4,    10,    14,    15,    16,     9,    11,     0,    16,
       3,     4,    17,    18,    19,     4,     5,     6,     7,     8,
      12,    18,    18,    19,    19
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 5: /* statement: IDENTIFIER ASSIGN expression  */
#line 44 "translate.y"
                                        {
                generate_code("=", (yyvsp[0].strval), NULL, (yyvsp[-2].strval));
            }
#line 1103 "translate.tab.c"
    break;

  case 6: /* statement: PRINT LPAREN IDENTIFIER RPAREN  */
#line 47 "translate.y"
                                           {
                generate_print((yyvsp[-1].strval));
            }
#line 1111 "translate.tab.c"
    break;
...
#line 52 "translate.y"
                ...
                generate_code("+", (yyvsp[-2].strval), (yyvsp[0].strval), temp);
                (yyval.strval) = strdup(temp);
            }
#line 1122 "translate.tab.c"
    break;
...
#line 1189 "translate.tab.c"
    break;


#line 1193 "translate.tab.c"
